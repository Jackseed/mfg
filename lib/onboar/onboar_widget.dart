...
import 'onboar_model.dart';
export 'onboar_model.dart';

class OnboarWidget extends StatefulWidget {
  const OnboarWidget({Key? key}) : super(key: key);

  @override
  _OnboarWidgetState createState() => _OnboarWidgetState();
}

class _OnboarWidgetState extends State<OnboarWidget>
    with TickerProviderStateMixin {
  late OnboarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnboarModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'onboar'});
    setupAnimations(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'kilk18g4' /* Pay attention to our new athle... */,
                                ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'ONBOAR_navigate_next_rounded_ICN_ON_TAP');
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                '70695dqp' /* Puuuurfect Running Gear */,
                              ),
                              style:
                                  FlutterFlowTheme.of(context).headlineMedium,
                            ).animateOnPageLoad(
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'lxlc4z0d' /* Pay attention to our new athle... */,
                                ),
                                style: FlutterFlowTheme.of(context).labelMedium,
                              ).animateOnPageLoad(
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'gsa0ktyc' /* The right pair of shoes */,
                              ),
                              style:
                                  FlutterFlowTheme.of(context).headlineMedium,
                            ).animateOnPageLoad(
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'dmk8g7fr' /* The pursuit of speed continues... */,
                                ),
                                style: FlutterFlowTheme.of(context).labelMedium,
                              ).animateOnPageLoad(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '77ye38o8' /* Sign up below in order to get ... */,
                                  ),
