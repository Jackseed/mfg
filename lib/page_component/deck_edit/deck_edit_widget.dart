...
class _DeckEditWidgetState extends State<DeckEditWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      // Get all avatars
      logFirebaseEvent('DeckEdit_Getallavatars');
      ...
      logFirebaseEvent('DeckEdit_update_component_state');
      setState(() {
                  ...
                  if (_model.nameInputController.text != null &&
                    ...
                    if (true) {
                      if (_model.selectedCardName != null &&
                        ...
                        // Update deck
                        logFirebaseEvent('save_button_Updatedeck');
                        ...
                        logFirebaseEvent(
                            'save_button_close_dialog,_drawer,_etc');
                        Navigator.pop(context);
                        // Deck edited!
                        logFirebaseEvent('save_button_Deckedited!');
                        ...
                        logFirebaseEvent('save_button_Youneedtosetanavatar');
                        setState(() {
                          _model.snackbarMessage = valueOrDefault<String>(
                            FFLocalizations.of(context).getVariableText(
                              enText: 'You need to set an avatar',
                        ...
                        logFirebaseEvent('save_button_update_component_state');
                        setState(() {
                      ...
                      logFirebaseEvent('save_button_Youneedtosetadeckowner');
                      setState(() {
                        _model.snackbarMessage = valueOrDefault<String>(
                          FFLocalizations.of(context).getVariableText(
                            enText: 'You need to set a deck owner',
                            frText: 'Le propriétaire du deck est requis',
                          ),
                          'You need to set a deck owner',
                        );
                        _model.showSnackbar = true;
                    ...
                    setState(() {
                      _model.snackbarMessage = valueOrDefault<String>(
                        FFLocalizations.of(context).getVariableText(
                          enText: 'You need to set a deck name',
                          frText: 'Le nom de deck est requis',
                        ),
